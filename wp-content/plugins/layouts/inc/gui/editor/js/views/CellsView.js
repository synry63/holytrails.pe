DDLayout.views.CellsView = DDLayout.views.abstract.CollectionView.extend({
    ...
    render: function (option) {
        ...
        //TODO: check this. We run this because Visual editor cell rendering first time with incorrect cell preview height.
        //Move this code somewhere.
        /* if ( typeof self.model.onstart_rerender == 'undefined' ){
         self.model.onstart_rerender = 1;
    ...
    afterRender: function () {
        //   console.log('cells after render', arguments );
        var self = this;
