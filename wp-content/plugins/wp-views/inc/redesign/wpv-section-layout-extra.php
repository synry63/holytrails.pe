					...
					<div class="code-editor layout-js-editor wpv-code-editor-closed js-wpv-code-editor js-wpv-layout-js-editor js-wpv-code-editor-closed hidden">
						<div class="code-editor-toolbar js-code-editor-toolbar">
							<ul>
								...
								if ( 'view' == $view_kind ) {
								?>
								<li class="js-editor-frontend-events-button-wrapper hidden">
									<button class="button-secondary js-code-editor-toolbar-button js-wpv-views-frontend-events-popup" data-content="wpv_layout_meta_html_js">
										<i class="icon-bell"></i>
										<span class="button-label"><?php _e('Pagination events','wpv-views'); ?></span>
									</button>
								</li>
								<?php
								}
