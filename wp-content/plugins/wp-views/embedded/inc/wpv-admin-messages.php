	...
	<div id="js-hidden-messages-boxes-pointers-container" class="popup-window-container">
		...
		if ( 
			...
			<div id="js-wpv-dialog-views-frontend-events" class="toolset-shortcode-gui-dialog-container wpv-shortcode-gui-dialog-container wpv-dialog-frontend-events">
				...
				<p>
					<?php echo __( 'Views offers some frontend javascript events so you can apply your own callbacks.', 'wpv-views' ); ?>
				</p>
					<h4><?php _e( 'Pagination events', 'wpv-views' ); ?></h4>
					<p><?php _e( 'Insert callbacks for the following events:', 'wpv-views' ); ?></p>
					<ul>
						<li>
							...
							<label for="wpv-frontent-event-pagination-completed"><?php _e( 'js_event_wpv_pagination_completed', 'wpv-views' ); ?></label>
						</li>
					</ul>
					<h4><?php _e( 'Parametric search events', 'wpv-views' ); ?></h4>
					<p><?php _e( 'Insert callbacks for the following events:', 'wpv-views' ); ?></p>
					<ul>
						<li>
							...
							<label for="wpv-frontent-event-parametric-search-triggered"><?php _e( 'js_event_wpv_parametric_search_triggered', 'wpv-views' ); ?></label>
						</li>
						<li>
							...
							<label for="wpv-frontend-event-parametric-search-started"><?php _e( 'js_event_wpv_parametric_search_started', 'wpv-views' ); ?></label>
						</li>
						<li>
							...
							<label for="wpv-frontend-event-parametric-search-form-updated"><?php _e( 'js_event_wpv_parametric_search_form_updated', 'wpv-views' ); ?></label>
						</li>
						<li>
							...
							<label for="wpv-frontend-event-parametric-search-results-updated"><?php _e( 'js_event_wpv_parametric_search_results_updated', 'wpv-views' ); ?></label>
						</li>
					</ul>
				</div>
			</div>
