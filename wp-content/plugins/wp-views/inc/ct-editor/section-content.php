...
function wpv_ct_editor_content_section_localize_script( $l10n_data ) {
    $l10n_data['content_section'] = array(
        ...
        'button_css' => array(
            'open' => __( 'Open CSS editor', 'wpv-views' ),
            'close' => __( 'Close CSS editor', 'wpv-views' )
        ),
        'button_js' => array(
            'open' => __( 'Open JS editor', 'wpv-views' ),
            'close' => __( 'Close JS editor', 'wpv-views' )
        ),
        'ptr_section' => array(
...
function wpv_ct_editor_content_section( $ct ) {
    ...
    <ul>
        <li class="wpv-has-itembox-header">
            <div class="wpv-itembox-header">
                <strong><?php _e( 'CSS editor', 'wpv-views' ); ?></strong>
                <button class="button button-secondary button-small wpv-code-editor-toggler"
                        data-bind="click: toggleCssEditor">
                    <i class="icon-pushpin" data-bind="widthToggleVisible: isCssPinVisible"></i>
                    <span data-bind="text: templateCssToggleButtonText"></span>
                </button>
            </div>
            <div class="code-editor" data-bind="editorVisible: isCssEditorExpanded" data-target-editor="css">
                <div class="code-editor-toolbar js-code-editor-toolbar">
                    <ul><?php wpv_ct_editor_content_add_media_button( $ct->id, 'wpv_template_extra_css' ); ?></ul>
                </div>
                <!--suppress HtmlFormInputWithoutLabel -->
                <textarea cols="30" rows="10" id="wpv_template_extra_css"
        ...
        <li class="wpv-has-itembox-header">
            <div class="wpv-itembox-header">
                ...
                <button class="button button-secondary button-small wpv-code-editor-toggler"
                        data-bind="click: toggleJsEditor">
                    <i class="icon-pushpin" data-bind="widthToggleVisible: isJsPinVisible"></i>
                    <span data-bind="text: templateJsToggleButtonText"></span>
                </button>
            </div>
            <div class="code-editor" data-bind="editorVisible: isJsEditorExpanded" data-target-editor="js">
                <div class="code-editor-toolbar js-code-editor-toolbar">
                    <ul><?php wpv_ct_editor_content_add_media_button( $ct->id, 'wpv_template_extra_js' ); ?></ul>
                </div>
                <!--suppress HtmlFormInputWithoutLabel -->
                <textarea cols="30" rows="10" id="wpv_template_extra_js"
