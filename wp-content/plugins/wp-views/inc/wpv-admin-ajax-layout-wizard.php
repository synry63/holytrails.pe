...
function wpv_layout_wizard_add_field() { // TODO this might need localization 
    ...
    global $WP_Views;
	$view_settings = $WP_Views->get_view_settings( $_POST["view_id"] );
	...
	$shortcode_selected = isset( $_POST['selected'] ) ? $_POST['selected'] : '';
    ...
    ob_start();
	?>
	<div id="layout-wizard-style_<?php echo ( isset( $_POST['id'] ) ) ? sanitize_text_field( $_POST['id'] ) : '__wpv_layout_count_placeholder__'; ?>" class="wpv-loop-wizard-item-container js-wpv-loop-wizard-item-container">
	...
	$data = array(
		'html' => $result_html,
        'shortcode_selected_found' => $shortcode_selected_found
	);
	wp_send_json_success( $data );
}
