                ...
                <#
                    ...
                    <a href="#" class="create-disabled-a js-show-cell-dialog js-item-details-data"
                       ...
                       data-disabled="disabled"
                        >
                    <span class="item-insert-disabled js-item-insert">Insert cell
                    <span class="dashicons dashicons-arrow-right-alt ddl-dialog-create-icon-arrow"></span>
                    </span>
                    </a>

                    <a href="#" class="ddl-open-promotional-message js-open-promotional-message promo-message-create-dialog js-open-promotional-message-button">Enable creating layouts</a>
                    ...
                    <# } else{ #>
                       ...
                       <a href="#" class="js-show-cell-dialog js-item-details-data"
                          ...
                          data-has-settings="{{hasSettings}}"
                           >
                    <span class="item-insert js-item-insert">Insert cell
                    <span class="dashicons dashicons-arrow-right-alt ddl-dialog-create-icon-arrow"></span>
                    </span>
                       </a>
                 <#   }
