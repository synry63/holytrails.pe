...
class WPV_Settings extends WPV_Settings_Embedded {
                ...
                <ul class="js-bootstrap-version-form">
                    <?php
                        ...
                        foreach( $version_options as $option ) {
                            ...
                            printf(
                                '<li><label><input type="radio" name="wpv-bootstrap-version" class="js-wpv-bootstrap-version" value="%s" %s %s />%s</label></li>',
                                $option['value'],
            ...
            <div class="wpv-setting-container">
                ...
                <div class="wpv-setting">
                    ...
                    <p class="update-button-wrap">
                        ...
                        <span class="js-wpml-spinner wpv-spinner hidden"></span>
        ...
        <div class="wpv-setting-container">
            ...
            <div class="wpv-setting">
                ...
                <p class="update-button-wrap">
                    ...
                    <span class="js-debug-spinner wpv-spinner hidden"></span>
    ...
    function wpv_update_bootstrap_version_status() {
        ...
        if( current_user_can('manage_options') && isset($_POST['wpv_bootstrap_version_nonce'] ) && wp_verify_nonce( $_POST['wpv_bootstrap_version_nonce'], 'wpv_bootstrap_version_nonce' )) {
            ...
            // todo there needs to be some centralized validation for options!
            $bootstrap_version = wpv_getpost( 'wpv_bootstrap_version_status', null, array( 1, 2, 3, -1 ) );
            if( null != $bootstrap_version ) {
                
                $this->wpv_bootstrap_version = $bootstrap_version;
                $this->save();
                die('ok');
