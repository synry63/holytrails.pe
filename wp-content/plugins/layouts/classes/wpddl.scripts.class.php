	...
	private function __initialize_scripts()
	{
		...
		if( isset( $_GET['page'] ) && 'dd_layouts_edit' == $_GET['page'] )
		{
            $this->scripts['icl_media-manager-js'] = new WPDDL_script('icl_media-manager-js',
				WPDDL_RELPATH . '/toolset-common/visual-editor/res/js/icl_media_manager.js',
				array('views-codemirror-script'));
			#editor
			$this->scripts['ddl-editor-main'] = new WPDDL_script('ddl-editor-main', (WPDDL_GUI_RELPATH . "editor/js/main.js"), array('headjs', 'jquery', 'backbone', 'toolset-utils','jquery-ui-tabs','icl_media-manager-js', 'jquery-effects-core', 'jquery-effects-highlight', 'jquery-effects-pulsate', 'jquery-ui-dialog'), null, true);
		...
		{
			$this->scripts['dd-listing-page-main'] = new WPDDL_script('dd-listing-page-main', (WPDDL_GUI_RELPATH . "listing/js/main.js"), array('headjs', 'jquery', 'backbone', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-dialog', 'jquery-ui-tooltip', 'jquery', 'jquery-ui-tabs'), WPDDL_VERSION, true);
		}
		...
		// Front End Scripts
		$this->scripts['ddl-layouts-frontend'] = new WPDDL_script('ddl-layouts-frontend', WPDDL_RES_RELPATH . '/js/ddl-layouts-frontend.js', array('jquery'), WPDDL_VERSION,true);
