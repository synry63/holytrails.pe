...
final class CRED_Helper {
    ...
    public static function setupAdmin() {
        ...
        self::getAdminPage(array(
            ...
            'base' => 'admin.php',
            'pages' => array('view-archives-editor', 'views-editor', 'ct-editor', 'CRED_Forms', 'CRED_Fields', 'CRED_Settings', 'CRED_Help')
        ));
...
//    }
    ...
    public static function jsForCredCustomPost() {
        ...
        elseif (
			self::$currentPage->isPostEdit || 
			self::$currentPage->isPostNew || 
			$screen->id == 'views-new_page_views-editor' || 
			$screen->id == 'views-new_page_view-archives-editor' ||
			$screen->id == 'views-new_page_ct-editor'
		) {
            ?>
            <script type='text/javascript'>
                /*<![CDATA[ */
...
// provide WPML localization for hardcoded texts
        ...
        if ($idcount == 1) {
            echo self::get_delete_post_link_js($message_after);
        }
    ...
    private static function get_delete_post_link_js($message_after) {
        ob_start();
        ?>
        <script type='text/javascript'>
            /* <![CDATA[ */
