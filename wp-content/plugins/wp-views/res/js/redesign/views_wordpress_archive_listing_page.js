...
WPViews.WPAListingScreen = function( $ ) {
    ...
    /**
     * When a colorbox dialog for creating new WPA is open, this indicates whether user
     ...
     * @since unknown
     */
    $(document).on( 'input change','.js-wpv-new-archive-name', function() {
    ...
    $(document).on('click', '.js-create-view-for-archive', function(e) {
        ...
        $.colorbox({
            ...
            onComplete: function() {
                ...
                // Update button availability, because we might have a pre-set WPA name.
                $('.js-wpv-new-archive-name').change();
            }
        });
        return false;
    });
...
jQuery(document).ready(function($) {
	...
	// @todo transform this to OOP model (see above)
